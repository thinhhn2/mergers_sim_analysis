...
sns.kdeplot(x=data_i['f_rot'], weights=data_i['mass'], gridsize=500,label='before',ax=ax)
sns.kdeplot(x=data_f['f_rot'], weights=data_f['mass'],gridsize=500,label='after',ax=ax)
